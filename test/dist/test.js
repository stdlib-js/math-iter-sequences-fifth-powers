...
var iterFifthPowersSeq = require( './../../dist' );
...
tape( 'main export is a function', function test( t ) {
	...
	t.strictEqual( typeof iterFifthPowersSeq, 'function', 'main export is a function' );
	t.end();
});
...
tape( 'the function returns an iterator protocol-compliant object which generates a sequence of fifth powers', function test( t ) {
	var expected;
	var actual;
	var it;
	var i;

	it = iterFifthPowersSeq();
...
tape( 'if an environment supports `Symbol.iterator`, the returned iterator is iterable', function test( t ) {
	var iterFifthPowersSeq;
	var it1;
	var it2;
	var i;

	iterFifthPowersSeq = proxyquire( './../dist/main.js', {
		'@stdlib/symbol-iterator': '__ITERATOR_SYMBOL__'
	});

	it1 = iterFifthPowersSeq();
